...
-- Q7. For each customer, how many delivered pizzas has at least 1 change and how many had no changes?
...
SELECT SUM(CASE
                WHEN c.exlusions <> '' AND c.extras <> '' THEN 1
                ELSE 0
...
SET DATEFIRST 1; -- The default setting for us_englishg is 7 (Sunday)
