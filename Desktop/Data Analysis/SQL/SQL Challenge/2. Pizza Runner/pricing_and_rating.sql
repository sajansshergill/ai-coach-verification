...
--      there were no charges - how much money has Pizza Runned made so far if there are no delivery fees?
SELECT SUM(CASE
...
-- Q2. What if there was an addition $1 charge for any pizza extras?
...
--      and insert your own data for ratings for each successful custome order between 1 to 5. 
DROP TABLE IF EXISTS ratng_orders;
