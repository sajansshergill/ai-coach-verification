...
SELECT calendar_year,
        ...
        CAST(100.0 * MAX(CASE
                            ...
                            ELSE NULL END
            / SUM(total_sales) AS decimal(5,3)) AS pct_shopify)))
FROM sales_cte
...
SELECT calendar_year,
        ...
        CAST(100 * MAX(CASE
                            WHEN demographoc = 'Families' THEN total_sales
                            ELSE NULL END)
...
-- Q9. Can we use the avg_transaction column to find the average transaction size for each year for Retails vs Shopify?
