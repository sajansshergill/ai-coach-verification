...
WITH salesChanges AS (SELCT SUM(CASE WHEN week_number BETWEEN @intWeekNum - 4 AND @intWeekNum -1 THEN sales END) before_changes,
...
-- Q3. How do the sales metrics for these 2 periods before and after compare with the previous years in 2018 and 2019?
