...
SELECT CONVERT(date, week_date, 3) AS week_date,
        ...
        DATEPART(WK, CONVERT(date, week_date, 3)) AS month_number,
        DATEPART(WK, CONVERT(date, week_date,3)) AS calendar_year,
        region,
        platform,
        segment,
        CASE
            WHEN RIGHT(segment, 1) = '1' THEN 'Young Adults'
            WHEN RIGHT(segmet, 1) = '2' THEN 'Middle Aged'
