...
--      Are they any months that the number of customers increasing significantly?
--      Customers growth: How manny customers increase by monthly? How does the rate look like (x1.5, x2, ... after each month)?
--      Conversion rate: Hoe many customers keep using Foodie-Fi after trial? How dow the rate look like (x1.5, x2, ... after each month)?
--      Churn rate: How many customers cancel the subscription by monthly? What plan they have used?
